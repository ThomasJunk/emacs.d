...
(setq dashboard-init-info "డ(°益°)హ ,( Bro, Even if you're swol, it doesn't mean you're a bro, bro. )")
...
(setq helm-split-window-in-side-p t ; open helm buffer inside current window, not occupy whole other window
  helm-move-to-line-cycle-in-source t ; move to end or beginning of source wihen reaching top or bottom of source.
